 ...
 * (leather can be dyed) and held items. Options (look - a navigator look or a shop keeper cosmetic - or npc.armor-stand in config.yml): small, arms, base-plate, plus the
