...
class BundledResourcesTest {
    ...
    private static final List<String> FILES = List.of("config.yml", "roles.yml", "loot.yml", "shop.yml",
            "scoreboard.yml", "guide.yml", "progress.yml", "cosmetics.yml", "npcs.yml", "quests.yml", "achievements.yml", "daily.yml", "lang/en.yml", "presets/classic.yml", "presets/quick.yml", "presets/hardcore.yml");
